...
'''
여러 줄 주석 
작은 따옴표 | 큰 따옴표를 앞뒤에 세개씩 표시함
파이썬에서는 single quotation or double quoation은 동일하게 취급함
'''
...
# abs(값 | 값을 가진 변수) -> 절대값 리턴 
print(abs(-10)) # 10 

# 파이썬에서는 변수는 반드시 값을 가져야 생성이 된다 (메모리에 할당)
