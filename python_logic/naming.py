# naming.py
# 식별자 : 개발자가 지어주는 이름
# 변수 (variable) : 프로그램 구도시 메모리 (RAM)에 값 기록하는 공간(방)
...
# 1. 대소문자 구분함 : name 과 Name 과 NAME 은 다른 이름
NAME = '홍길동'
name = '이순신'
Name = '황진이'
...
# 1num = 100
# print(1num, type(1num)) #SyntaxError: invalid decimal literal 오타
...
# num& = 12 #SyntaxError: invalid syntax 잘못된 기호 사용
# print(num&)

# 5. 이름 중간 또는 끝에는 숫자 사용 가능 : num1, first1_num
num1 = 10
num2 = 20
...
# 예약어 확인 : keyword 모듈에서 제공됨 => import해서 사용함
